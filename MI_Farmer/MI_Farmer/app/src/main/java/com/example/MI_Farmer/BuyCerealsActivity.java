...
public class BuyCerealsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_cereals);
        ...
        applesCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                resource = R.drawable.frenchpeas;
        ...
        waterMelonCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cartPopup.setVisibility(View.VISIBLE);
                resource = R.drawable.greengrams;
                subTotal = amountSet * cropPrice;
                finalSubTot = String.valueOf(subTotal);
            ...
            public void onClick(View v) {
                ...
                if (!(amountItems.getText().toString().trim().equals(""))){
                    ...
                    if (amountSet > 0){
                        ...
                        Toast.makeText(BuyCerealsActivity.this, "1 item has been added to the cart.", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(BuyCerealsActivity.this, "Amount cannot be 0.", Toast.LENGTH_SHORT).show();
                    }
                }else{

                    Toast.makeText(BuyCerealsActivity.this, "Amount cannot be empty.", Toast.LENGTH_SHORT).show();
                }
