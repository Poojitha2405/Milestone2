...
public class BuyNutsActivities extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (!(amountItems.getText().toString().trim().equals(""))){
                    ...
                    if (amountSet > 0){
                        ...
                        Toast.makeText(BuyNutsActivities.this, "1 item has been added to the cart.", Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(BuyNutsActivities.this, "Amount cannot be 0.", Toast.LENGTH_SHORT).show();
                    }
                }else{

                    Toast.makeText(BuyNutsActivities.this, "Amount cannot be empty.", Toast.LENGTH_SHORT).show();
                }
